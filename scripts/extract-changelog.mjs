...
function githubBanner() {
  return [
    ...
    '>',
    '> **Install Windows from the [Microsoft Store](https://apps.microsoft.com/detail/9P32SFSJH9B1) only.**',
    '>',
    '> **Linux:** use the **AppImage** below from this GitHub Release.',
    '',
    '| Asset | Platform |',
    '| --- | --- |',
    '| `EG-Launcher-*-linux-*.AppImage` | **Linux x64** (only installer on GitHub) |',
    '| Windows | **[Microsoft Store](https://apps.microsoft.com/detail/9P32SFSJH9B1)** — not distributed as setup.exe here |',
    '',
